...
SECRET_KEY = 'django-insecure-&aj^w%!x5vkrkm3ts%f5%hy-v*)13!u-&pik_644@y=%y1hp8j'
...
JAZZMIN_SETTINGS = {
    'site_title': 'Grey Scientific Labs',
    'site_header': 'Grey Scientific Labs',
    'site_brand': 'Grey Scientific Labs',
    'welcome_sign': 'Welcome to the Admin Area',
    'copyright': 'Grey Scientific Labs',
